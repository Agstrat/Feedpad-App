  ...
  if (!d) {
    return (
      <div className="page-wrap">
        <div className="card"><h2 className="v">Default Settings</h2><p>Loading…</p></div>
      </div>
    )
  }

  const set = <K extends keyof Defaults>(k: K, v: Defaults[K]) => setD({ ...d, [k]: v })
    ...
    <div className="page-wrap">
      <div className="card">
        ...
        <div className="actions" style={{ marginTop: 18 }}>
          ...
          <button className="btn btn-sm secondary" onClick={() => nav('/')}>Cancel</button>
        </div>
      </div>
    </div>
  )
